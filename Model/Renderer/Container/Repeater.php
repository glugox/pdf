...
class Repeater extends \Glugox\PDF\Model\Renderer\Container\AbstractRenderer
{
    ...
    protected function _createItems(){
        ...
        //$rendererClass = \get_class($child);
        $order = 1;

        /*$defaultArguments = [
            Layout::ATTRIBUTE_KEY_TYPE=> $child->getType(),
            Layout::ATTRIBUTE_KEY_ORDER => $order,
            Layout::ATTRIBUTE_KEY_STYLE => $child->getStyle()->getSource(),
            Layout::ATTRIBUTE_KEY_SRC => null ];*/


        //$dummyChildren = $child->getChildren();
        /**
         * Remove all children
         */
        $this->_children = [];
        ...
        foreach ($this->_items as $item) {
            ...
            //$defaultArguments[Layout::ATTRIBUTE_KEY_ORDER] = $order;
            //$defaultArguments[Layout::ATTRIBUTE_KEY_SRC] = $item;
    ...
    {
        return parent::getIsRendered(); // TODO: Change the autogenerated stub
    }
    ...
    {
        return parent::hasChildren(); // TODO: Change the autogenerated stub
    }
    ...
    {
        return parent::sortChildren(); // TODO: Change the autogenerated stub
    }
    ...
    {
        parent::removeRenderedChildren(); // TODO: Change the autogenerated stub
    }
}